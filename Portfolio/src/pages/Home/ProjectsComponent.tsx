...
function ProjectsComponent({stylesModule}: {stylesModule: StylesModule}) {
    ...
    return(
        ...
        <Container ref={ref} className="mt-5 d-flex flex-column justify-content-center align-items-center text-center" id="projects-page">
            ...
            <a className={stylesHome.projectsLink} href="https://github.com/NiushaEbrahimi?tab=repositories">
                Check Them Out
                <svg xmlns="http://www.w3.org/2000/svg" fill="var(--color-7)" className="bi" viewBox="0 0 16 16" aria-hidden="true">
